<?php namespace App\Http\Controllers;
	...
	class AdminPenjualanController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Nama Pelayan","name"=>"namapelayan"];
			$this->col[] = ["label"=>"ID Client","name"=>"id_client","join"=>"customers,id_cust"];
			$this->col[] = ["label"=>"Total All","name"=>"total_all"];
			$this->col[] = ["label"=>"Discount","name"=>"discount"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Nama pelayan','name'=>'namapelayan','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Client','name'=>'id_client','type'=>'text','validation'=>'integer','width'=>'col-sm-9'];
			$this->form[] = ['label'=>'Total All','name'=>'total_all','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Discount','name'=>'discount','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			# END FORM DO NOT REMOVE THIS LINE

			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ['label'=>'Client','name'=>'id_client','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'client,id'];
			//$this->form[] = ['label'=>'Total All','name'=>'total_all','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Discount','name'=>'discount','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			# OLD END FORM
	    ...
	    public function getIndex() {
		   ...
		   $data['productname'] = DB::table('products')->get();
		   $this->cbView('invoice.coba',$data);
		   return $id;
		}
